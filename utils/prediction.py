...
def capture_mp(config_demo, logger: Logger, max_frames=100):
    ...
    # 定义视频编码器
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')   # 或 'XVID' 对应 avi
...
def generate_txt(config_demo, logger: Logger):
    ...
    process_video(vp, video_path,
                  txt_path, txt_path, logger)
